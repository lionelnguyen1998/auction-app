                    ...
                    <div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women">
                        ...
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img @if(is_null($images)) src="{{ $item["images"][0]["image"] }}" @else src="adafs" @endif alt="IMG-PRODUCT">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="{{ route('detailAuctions', ['auctionId' => $item['auction_id'], 'itemId' => $item['item_id']]) }}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                        {{ $item['name'] }}
                                    </a>
                                </div>
									...
									<div class="col-md-6 col-lg-5 p-b-30">
										<div class="p-r-50 p-t-5 p-lr-0-lg">
											...
											<span class="mtext-106 cl2">
												Gia khoi diem: {{ $item['starting_price'] }}
											</span>
